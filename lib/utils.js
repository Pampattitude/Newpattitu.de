...
var cheerioLib = require('cheerio');
...
var cleanHtmlInput = function(html, validTags, validAttributes) {
    ...
    $('*').each(function() {
        ...
        (function() {
            ...
            if (!found) {
                consoleLib.debug('Removing tag ' + (this[0].name || this[0].tagName));
                $(this).remove();
            }
        }).call(this);
        ...
        (function() {
            ...
            for (var attr in attrs) {
                ...
                if (!found) {
                    consoleLib.debug('Removing attribute ' + attr + ' of tag ' + (this[0].name || this[0].tagName));
