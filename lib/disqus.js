...
exports.getUrlPosts = function(threadUrl, callback) {
    ...
    return exports.listThreads(function(err, res) {
        ...
        if (!thread)
            return callback(new Error('Unknown thread "' + threadUrl + '"'))
...
/*
var threadUrl = 'http://beta.pampattitu.de/article/new_commenting_system';
exports.connect(function(err) {
        console.time('1');
    return exports.getUrlPosts(threadUrl, function(err, res) {
        if (err) {
